...
120 by 30 is ideal. `ascii_big.txt` must be in the working directory (the Visual
Studio project folder) or next to the executable. Type each line and check the
